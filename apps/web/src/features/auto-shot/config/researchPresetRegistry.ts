...
export const researchPresetRegistry: AutoShotPresetRegistry = Object.freeze({
  general: {
    ...
    version: 1,
    name: "通用视频",
    description: "未知类型视频的安全研究起点。",
    catalog: "research",
    status: "uncalibrated",
    sourceNote: researchNote,
    baseConfig: adaptive(3500, 2, 1500),
    detailAdjustments: {
      conservative: { thresholdDelta: 600, minimumContentScoreDelta: 300 },
      balanced: { thresholdDelta: 0, minimumContentScoreDelta: 0 },
      detailed: { thresholdDelta: -500, minimumContentScoreDelta: -250 },
    },
    defaultMinimumSceneDurationSeconds: 0.6,
  ...
  "film-series": {
    ...
    version: 1,
    name: "电影 / 剧集",
    description: "长叙事内容，允许研究淡入淡出与黑场转场。",
    catalog: "research",
    status: "uncalibrated",
    sourceNote: researchNote,
    ...
    defaultTransitions: "hard-cuts-and-fades",
  },
  "short-form": {
    id: "short-form",
    version: 1,
