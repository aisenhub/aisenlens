...
export const EDITOR_SHORTCUT_DEFINITIONS: readonly EditorShortcutDefinition[] = [
  ...
  { action: "playback.stepBack", key: "← / ,", keys: ["ArrowLeft", ","], description: "后退一帧（镜头列表聚焦时限于当前分镜）", category: "播放与定位" },
  { action: "playback.stepForward", key: "→ / .", keys: ["ArrowRight", "."], description: "前进一帧（镜头列表聚焦时限于当前分镜）", category: "播放与定位" },
  { action: "playback.jumpBack", key: "Shift + ←", description: "后退 5 帧（镜头列表聚焦时限于当前分镜）", category: "播放与定位" },
  { action: "playback.jumpForward", key: "Shift + →", description: "前进 5 帧（镜头列表聚焦时限于当前分镜）", category: "播放与定位" },
  { action: "playback.previousBoundary", key: "↑", description: "上一个分镜", category: "播放与定位" },
  { action: "playback.nextBoundary", key: "↓", description: "下一个分镜", category: "播放与定位" },
