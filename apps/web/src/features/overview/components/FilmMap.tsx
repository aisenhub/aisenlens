...
interface FilmMapProps { facts: FilmOverviewFacts; onSelectShot: (index: number) => void }

export default function FilmMap({ facts, onSelectShot }: FilmMapProps) {
