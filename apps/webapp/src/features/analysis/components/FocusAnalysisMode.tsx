...
export default function FocusAnalysisMode({ profile, entries, shots, activeShotId, queue, onLocateShot, onCommand, onCopyPrevious, onExit, onEditingStart, onEditingEnd }: FocusAnalysisModeProps) {
  ...
  useEffect(() => {
    ...
    const onKeyDown = (event: KeyboardEvent) => {
      ...
      const isTypingTarget = target instanceof HTMLElement && target.matches("input, textarea, select, button, [contenteditable='true']")
      if (event.isComposing || event.repeat || isTypingTarget) return
