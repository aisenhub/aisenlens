...
interface OverviewViewProps { view: WorkflowView; shots: ShotData[]; shotFrames: Record<string, { first: number; last: number }>; groups: ShotGroupRecord[]; markers: AnnotationMarker[]; durationSeconds: number; frameRate: number | null; selectedShotId?: string | null; onViewChange: (view: "timeline" | "structure") => void; onSelectShot: (index: number) => void; onEnterResearch?: (shot: ShotData) => void; onEnterSequential?: () => void; onOpenScene: (group: ShotGroupRecord) => void; onStartSelection: () => void }
