---
title: "AisenLens Analysis Workspace"
...
depends_on:
  ...
  - ANALYSIS_INSPECTOR
source_of_truth_for:
  - analysis-workspace-composition
  - analysis-navigation-state
  - research-scope
  - selection-playback-separation
  - cross-workspace-shot-correction
implementation_areas:
  - apps/webapp/src/features/analysis
  - apps/webapp/src/features/annotation
  - apps/webapp/src/features/template
  - apps/webapp/src/features/group
  - apps/webapp/src/features/workflow
---

# AisenLens 逐镜分析工作台 UI / UX / 交互架构方案

> 本版将 Inspector 数据模型、Timeline 详细契约和 Evidence/Provenance 规则下沉到 `04-domain` 与 Inspector 专项文档。原章节编号保留，便于与输入稿对照。
...
> **Template Authority 注记（2026-09-17）**：以下原始工作台说明完整保留，用于解释 Analysis Workspace 如何使用 Template；Template 的领域定义、持久化职责与子契约以 `../04-domain/template/TEMPLATE_CONTRACT.md` 为唯一权威。若下文措辞与该契约冲突，以 Template Contract 为准。
