...
### 11.1 结构边界只吸附到更低一级有效边界

建议：

- Scene Boundary → 只能位于 Shot Boundary
- Sequence Boundary → 优先位于 Scene Boundary
- Section Boundary → 优先位于 Sequence Boundary
...
> **time 是真实锚点，context / scope 是语义上下文。**
...
### Phase 4：AI Structural Suggestions
